...
func (m *MockCacheHelper) GetMappedNavigationContent(ctx context.Context, lang string) ([]model.NavigationItem, error) {
	m.ctrl.T.Helper()
	ret := m.ctrl.Call(m, "GetMappedNavigationContent", ctx, lang)
	ret0, _ := ret[0].([]model.NavigationItem)
	ret1, _ := ret[1].(error)
	return ret0, ret1
}
...
func (mr *MockCacheHelperMockRecorder) GetMappedNavigationContent(ctx, lang interface{}) *gomock.Call {
	mr.mock.ctrl.T.Helper()
	return mr.mock.ctrl.RecordCallWithMethodType(mr.mock, "GetMappedNavigationContent", reflect.TypeOf((*MockCacheHelper)(nil).GetMappedNavigationContent), ctx, lang)
}

// RunUpdates mocks base method.
func (m *MockCacheHelper) RunUpdates(ctx context.Context, svcErrors chan error) {
	m.ctrl.T.Helper()
	m.ctrl.Call(m, "RunUpdates", ctx, svcErrors)
}
...
func (mr *MockCacheHelperMockRecorder) RunUpdates(ctx, svcErrors interface{}) *gomock.Call {
	mr.mock.ctrl.T.Helper()
	return mr.mock.ctrl.RecordCallWithMethodType(mr.mock, "RunUpdates", reflect.TypeOf((*MockCacheHelper)(nil).RunUpdates), ctx, svcErrors)
}
